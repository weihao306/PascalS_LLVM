...
{
    module = new llvm::Module("Pascal_S", GlobalLLVMContext::getGlobalContext());
}
...
llvm::Function *CodeGenContext::getPrintfPrototype()
{
    ...
    llvm::FunctionType *printf_type = llvm::FunctionType::get(llvm::Type::getInt32Ty(ctx), 
                                            printf_arg_types, true);
    llvm::FunctionType *func = llvm::Function::Create(printf_type, llvm::Function::ExternalLinkage, 
